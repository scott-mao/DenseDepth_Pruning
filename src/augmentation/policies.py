...
'''hJ'''
def simple_augment_train_mnist() -> transforms.Compose:
...
def simple_augment_test_mnist() -> transforms.Compose:
    return transforms.Compose(
        [
            transforms.ToTensor(),
...
def simple_augment_train_nyu() -> transforms.Compose:
    return transforms.Compose(
        [
            transforms.ToTensor(),
...
def simple_augment_test_nyu() -> transforms.Compose:
    return transforms.Compose(
        [
            transforms.ToTensor(),
