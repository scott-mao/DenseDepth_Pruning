...
#from src.densedepth_utils import AverageMeter, DepthNorm, colorize
from src.densedepth_loss import ssim
from src.densedepth_utils import AverageMeter, DepthNorm, colorize
...
class Trainer(Runner):
    ...
    def __init__(
        ...
        # count parameter numbers in the model
    ...
    def setup_train_configuration(self, config: Dict[str, Any]) -> None:
        ...
        self.trainloader, self.testloader = getTrainingTestingData(batch_size = 2)
        # get dataloaders
    ...
    def train_one_epoch(self) -> Tuple[float, Dict[str, float]]:
        ...
        for sample_batched in progressbar(self.trainloader, prefix="[Train]\t"):
            ...
            avg_loss = sum(losses2) / len(losses2)
